...
<div class="woocommerce-order">
    ...
    <p
        class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received text-center text-4xl mb-10 text-brown font-semibold font-alt">
    ...
    <ul
        class="woocommerce-order-overview woocommerce-thankyou-order-details order_details mb-10 grid grid-cols-2 sm:grid-cols-5 before:hidden">
