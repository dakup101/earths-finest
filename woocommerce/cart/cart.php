...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        <tbody>
            ...
            <tr
                ...
                <td class="product-name font-alt text-xl text-brown"
            ...
            <tr>
                <td colspan="6" class="actions flex justify-between w-full">
    ...
    <div class="flex flex-col sm:flex-row gap-5 justify-between">
        ...
        <div class="coupon flex flex-col sm:flex-row gap-5 items-center">
            <input type="text" name="coupon_code"
                class="input-text px-10 py-2.5 block border border-brownish rounded-full w-full" id="coupon_code"
                value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" />
            <button type="submit" class="ef-accent-btn w-full sm:w-fit shrink-0" name="apply_coupon"
        ...
        <button type="submit" class="ef-accent-alt-btn w-full sm:w-fit " name="update_cart"
