...
<section class="container mx-auto sm:px-20 md:px-32 xl:px-56 mt-3">
    ...
    <div class="grid gap-5 sm:gap-10 mb-10">
        ...
        <div class="accordion-item">
            <div
                class="accordion-trigger font-alt leading-normal cursor-pointer text-2xl sm:text-3xl md:text-4xl flex items-start text-brown font-semibold">
            ...
            <div
                class="accordion-content overflow-hidden transition-all text-lg sm:text-xl md:text-2xl text-dark-light">
